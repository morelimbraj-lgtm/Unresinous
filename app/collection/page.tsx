  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col items-center justify-center text-center z-10">
        <span className="text-[11px] uppercase tracking-[0.2em] text-[#FF6321] font-semibold mb-4">Curated</span>
        ...
        <p className="text-[14px] leading-[1.6] opacity-50 max-w-[400px]">
          Explore our latest engineered garments designed for extreme climates and urban exploration.
        </p>
      </div>
    </motion.div>
  );
