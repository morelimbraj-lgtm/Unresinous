  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col items-center justify-center text-center z-10">
        <span className="text-[11px] uppercase tracking-[0.2em] text-[#FF6321] font-semibold mb-4">Legacy</span>
        ...
        <p className="text-[14px] leading-[1.6] opacity-50 max-w-[400px]">
          A retrospective look at our foundational pieces and past innovations.
        </p>
      </div>
    </motion.div>
  );
